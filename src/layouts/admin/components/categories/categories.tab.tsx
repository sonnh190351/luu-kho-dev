...
export default function CategoriesTab() {
    ...
    const [items, setCategories] = useState<Categories[]>([])
    ...
    return (
        <>
            ...
            {/*Item modal*/}
            <CategoriesModal category={selectedItem} open={openItemModal} refresh={fetchCategories} close={handleCloseItemModal}/>
        </>
    )
}